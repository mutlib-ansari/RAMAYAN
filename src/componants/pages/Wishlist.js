...
const WishlistPage = () => {
  ...
  return (
    <div className="container mx-auto py-8 lg:max-w-6xl relative top-16">
      <h1 className="text-6xl font-semibold mb-24 text-center ">Your Wishlist</h1>
      ...
      <div className="text-right mt-6">
        ...
        <Link to="/checkout" className="mt-4 inline-block bg-yellow-500 text-white py-2 px-4 rounded-lg hover:bg-yellow-600">
          Proceed to Checkout
        </Link>
      </div>
    </div>
